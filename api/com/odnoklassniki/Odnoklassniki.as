package api.com.odnoklassniki 
{
	...
	import api.com.odnoklassniki.net.OdnoklassnikiRequest;
	...
	public class Odnoklassniki extends EventDispatcher
	{
		 ...
		 */
		public static function initialize(base:DisplayObject, secretKey:String):void 
		{
			var flash_vars:Object = getFlashVars(base);
		...
		{
			getInstance().send("showPermissions", [api.com.adobe.json.JSON.encode(permissions)]);
		}
